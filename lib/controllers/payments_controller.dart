...
import 'package:project_deapsea2/screens/payments/payments.dart';
import 'package:project_deapsea2/utils/helpers/showLoading.dart';
...
class PaymentsController extends GetxController {
  ...
  void onReady() {
    ...
    StripePayment.setOptions(StripeOptions(
        publishableKey: "pk_test_51KiI9eKs2mCDYIz0lofUsGUeqSYFCmN82lVIACIawAudrf7lWhOu7yXxwEipMZAnOsa5wvfF2yYCP6U03sKQbiLh003b9OE2kB",
        androidPayMode: ''));
  }
  ...
  Future<void> createPaymentMethod() async {
    StripePayment.setStripeAccount.toString();
    //step 1: add card
