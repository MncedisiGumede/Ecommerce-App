...
import 'package:project_deapsea2/screens/splash/components/splash_content.dart';
...
class _BodyState extends State<Body> {
  ...
  List<Map<String, String>> splashData = [
    {
      "text" : "Welcome to MATHEBE-TECH, Let's shop!",
      "image": "assets/images/splash_1.png",
    },
    {
      "text":
          "We help people find their preferred tech \n around South Africa",
